...
//               backgroundImage: AssetImage("assets/images/police.png"), // replace with your image path
//             ),
...
//                     spreadRadius: 2,
//                     blurRadius: 6,
//                     offset: const Offset(0, 2),  // Shadow position (only downward)
//                   ),
//                 ],
//               ),
//               child: Padding(
      ...
      body: SafeArea(
        child: Column(
          children: [
            ...
            Container(
              height: size.height * 0.45, // 👈 Increased height
              width: double.infinity,
